...
We use this service for both <a href="https://www.jcubhomefinder.com/">Production Site</a> and <a href="https://jcubhomefindercom.stage.site/">Staging Site</a>. Since staging server is password protected to prevent search engines from confusing ot with live site. Thus to check the staging server we would provide the username and password at LearnJCU.
